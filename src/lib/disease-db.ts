...
export const DISEASE_DB: DiseaseEntry[] = [
  ...
  // ─── MAIZE DISEASES ───
  {
    ...
    similarDiseases: ['maize_southern_leaf_blight', 'maize_gray_leaf_spot'],
  ...
  // ─── TOMATO DISEASES ───
  {
    ...
    similarDiseases: ['tomato_mosaic_virus', 'tomato_yellow_leaf_curl'],
  ...
  // ─── BRINJAL DISEASES ───
  {
    ...
    similarDiseases: ['brinjal_epilachna_beetle'],
